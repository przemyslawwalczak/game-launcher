...
Module.prototype.require = function require (...path) {
  if (this.paths.indexOf(process.env.cwd) === -1) {
    this.paths.unshift(process.env.cwd)
  }
...
module.exports.attributes = new Attributes('application.yaml')

require('application/electron')
